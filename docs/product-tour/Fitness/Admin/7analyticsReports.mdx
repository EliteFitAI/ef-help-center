...
![Treatment plan page](/img/WorkoutReport1.webp)
...
![Treatment plan page](/img/WorkoutReport7.webp)
...
![Treatment plan page](/img/WorkoutReport6.webp)

     - Click *Schedule* to confirm.

![Treatment plan page](/img/WorkoutReport8.webp)

 4. Under *History*, you can view all the reports you have scheduled previously.

![Treatment plan page](/img/WorkoutReport9.webp)
