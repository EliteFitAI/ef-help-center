...
2. **End Users (Clients)**: Have access to their personal accounts to view treatment plans, badges earned,etc.
...
![Admin User Management](/img/UserMan4.webp)

7. A confirmation message will appear: “Invite has been sent”.

![Admin User Management](/img/UserMan5.webp)
...
![Admin User Management](/img/UserMan12.webp)
...
![Admin User Management](/img/UserMan6.webp)

3. A pop-up window will appear.
4. Enter the end user’s email address.
5. Select the team you want to assign the user to.

![Admin User Management](/img/UserMan7.webp)

6. Click on Send Invite.
7. A confirmation message will appear: “Invite has been sent.”

![Admin User Management](/img/UserMan8.webp)
...
![Admin User Management](/img/UserMan11.webp)