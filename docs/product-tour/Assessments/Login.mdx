...
import myImage from '@site/static/img/Assessment3.webp';
...
{(() => {
  const questions = [
                      ...
                      },
                      {
                        ...
                        img: myImage,
                        answer: [
                          "To edit your profile details, click on your profile (the icon on top right corner) and select 'Edit Profile'.",
