...
import myImage from '@site/static/img/Assessment1.webp';

{(() => {
  const questions = [
                      {
                        id: 11,
                        question: "Where can I continue my incomplete workouts?",
                        icon: "help_outline",
                        answer: [
                          "You can continue your workout assessments by scrolling down to the 'Resume your assessment' section."
                        ],
                        tips: [
                          "Resume your workout in a distraction-free environment."
                        ],
                        cautions: [
                          "Ensure your internet connection is stable before resuming.",
                          "Do not switch devices midway, as progress may not sync."
                        ]
                      },
                      {
                        id: 12,
                        question: "Do I lose my progress if I leave my assessment in between?",
                        icon: "help_outline",
                        answer: [
                          "No, you can continue your assessment anytime without losing any progress."
                        ],
                        tips: [
                          "If you need a break, you can safely save it, exit and return later.",
                          "Check the 'Resume your assessment' section to pick up where you left off."
                        ],
                        cautions: [
                          "Avoid closing your browser while mid-exercise to prevent temporary errors.",
                          "Do not clear cache or cookies until your assessment is completed."
                        ]
                      },
                      {
                        id: 13,
                        question: "Are my workouts being recorded?",
                        icon: "help_outline",
                        answer: [
                          "No, we do not store any video or image from your workout.",
                          "The entire process is completed locally on your device."
                        ],
                        tips: [
                          "Recommended to use a private and well-lit space for your workouts.",
                          "Relax knowing your privacy is maintained at all times."
                        ]
                      },
                      {
                        id: 14,
                        question: "Can I continue my assessments later? Would that lose all my progress?",
                        icon: "help_outline",
                        img: myImage,
                        answer: [
                          "You can continue your assessment anytime by scrolling down to the 'Resume your assessment' section.",
                          "Here you can see all your currently incomplete assessments and continue them anytime."
                        ],
                        tips: [
                          "Plan your assessments when you have 10–15 minutes free to reduce interruptions.",
                          "Use the same device for consistency when resuming."
                        ],
                        cautions: [
                          "Do not refresh or exit during a live exercise—it may temporarily pause tracking.",
                          "Ensure your session is resumed before starting new assessments."
                        ]
                      }
                    ]
  ...
  if (id) {
    ...
    return (
      ...
      <div className=" relative w-full h-0 flex flex-col items-end justify-start rounded-lg">
        ...
        {/* Image */}
        <img src={q.img} className="my-2 w-[100%] object-contain" />
