...
export default function Home() {
  ...
  useEffect(() => {
    if (ExecutionEnvironment.canUseDOM) {
      ...
      let urrl =
          mode !== 'Assessment'
              ? `/product-tour/${mode}/Admin/4addingUsers`
        ...
        <main className="container" style={{ padding: '2rem 0' }}>
          <section className="text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
              <Link
                  to="/get-started/Welcome"
                  className="text-left group cursor-pointer flex flex-col p-5 border border-gray-100 dark:border-gray-700 rounded-xl dark:bg-gray-800 bg-green-50 hover:border-green-300 dark:hover:border-green-700 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-center mb-3">
                  <div className="text-lg font-bold text-gray-900 m-0">
                    <div className="text-inherit no-underline hover:text-green-600 dark:text-green-200 transition-colors">
                      Getting started
                    </div>
                  </div>
                </div>
              ...
              <Link
                  to="/troubleshoot/1submitting_support_requests"
                  className="text-left group cursor-pointer flex flex-col p-5 border border-gray-100 dark:border-gray-700 rounded-xl dark:bg-gray-800 bg-green-50 hover:border-green-300 dark:hover:border-green-700 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-center mb-3">
                  <div className="text-lg font-bold text-gray-900 m-0">
